...
```
This plot shows the distribution of data_value for responses (“Poor” to “Excellent”) among locations in NY State in 2006 and 2010 respectively. Based on the visulizaiton, the group with "poor" responses has the lowest data values at both years, good and very good responses have relativelty high data values.
